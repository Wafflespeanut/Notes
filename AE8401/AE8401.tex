...
\hbox{\hspace{-4.5cm}\includegraphics[scale=1.35]{Truss.pdf}}
\end{figure}
\newpage
...
\hbox{\hspace{-2.2cm}\includegraphics{Beam_A.pdf}}
\end{figure}
\begin{enumerate}[(i)]
...
\hbox{\hspace{-2.2cm}\includegraphics{Beam_B.pdf}}
\end{figure}
\begin{enumerate}[(i)]
...
\hbox{\hspace{-2.2cm}\includegraphics{Beam_C.pdf}}
\end{figure}
\begin{enumerate}[(i)]
...
\end{enumerate}
\begin{figure}
\hbox{\hspace{-9.2cm}\includegraphics[scale=0.9]{Moment.pdf}}
