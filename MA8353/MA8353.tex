...
\item To get the least Eigen value, find {\LARGE $\mathrm{B=A-\lambda I}$} and choose an Eigen vector {\LARGE $\psi_0$}
...
\end{enumerate}
\subsection{\LARGE Eigen values using Jacobian method:}
\begin{enumerate}[(i)]
\item 
\end{enumerate}
\newpage
